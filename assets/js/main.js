...
function toggleNav() {
	$(".navigation").toggleClass("navigation-active"), $(".navigation").hasClass("navigation-active") && $(".menu").removeClass("light").addClass("light"), !$(".menu").hasClass("intro-active") && $(".hamburger").hasClass("close") && $(".menu").removeClass("light").addClass("light"), $(".hamburger").toggleClass("close")
}
...
$(document).ready(function() {
	mobile() && ($("body").addClass("mobile"), $(".card").addClass("touch")), $("ul.main li").click(function() {
		...
		$("a#exit").click(function(a) {
			a.preventDefault();
			var i = this.href;
			$(this).hasClass("logo") ? ($(".is-exiting").addClass("light"), $(".menu").addClass("light").removeClass("light")) : $(".menu").removeClass("light").addClass("light"), $(".is-exiting").fadeIn(300), setTimeout(function() {
			window.location = i
		}, 1e3)
